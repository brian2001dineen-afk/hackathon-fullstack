...
- [Reflections](#reflections)
  ...
  - [User Experience (UX)](#user-experience-ux)
    ...
    - [User Stories](#user-stories)
      ...
      - [Won't-Have Features (Future Scope)](#wont-have-features-future-scope)
  ...
  - [Features](#features)
    - [Existing Features](#existing-features)
      - [🏠 Home Page (`/`)](#-home-page-)
      - [📝 Post Detail Page (`/post/<slug>/`)](#-post-detail-page-postslug)
      - [👤 User Authentication](#-user-authentication)
      - [ℹ️ About Page (`/about/`)](#-about-page-about)
      - [🛠️ Admin Dashboard (`/admin/`)](#-admin-dashboard-admin)
      - [💬 Interactive Features](#-interactive-features)
    - [CRUD Functionality](#crud-functionality)
      - [Posts (Admin Only)](#posts-admin-only)
      - [Comments (Authenticated Users)](#comments-authenticated-users)
      - [About Page Content (Admin Only)](#about-page-content-admin-only)
      - [Collaboration Requests (All Users)](#collaboration-requests-all-users)
  - [Testing](#testing)
  ...
  - [Technologies Used](#technologies-used)
    ...
    - [Database Structure](#database-structure)
      ...
      - [CollaborateRequest Model](#collaboraterequest-model)
